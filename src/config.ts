...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      rx6600xt: envOrArray(process.env.DISCORD_NOTIFY_GROUP_RX6600XT),
      ...
      'usb14tb': envOrArray(process.env.DISCORD_NOTIFY_GROUP_USB14TB),
      'usb16tb': envOrArray(process.env.DISCORD_NOTIFY_GROUP_USB16TB),
      'usb18tb': envOrArray(process.env.DISCORD_NOTIFY_GROUP_USB18TB),
    },
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      rx6600xt: envOrNumber(process.env.MAX_PRICE_SERIES_RX6600XT),
      ...
      'usb14tb': envOrNumber(process.env.MAX_PRICE_SERIES_USB14TB),
      'usb16tb': envOrNumber(process.env.MAX_PRICE_SERIES_USB16TB),
      'usb18tb': envOrNumber(process.env.MAX_PRICE_SERIES_USB18TB),
    },
  },
